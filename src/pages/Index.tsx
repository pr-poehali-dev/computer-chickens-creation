              ...
              <CardHeader className="bg-primary/5">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center">
                    <Icon name="Laptop" className="text-primary" size={24} />
                  </div>
                  <div>
                    <CardTitle className="text-2xl">Компьютерная азбука для начинающих</CardTitle>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0"></div>
                      <p className="text-muted-foreground">
                        <span className="font-medium text-foreground">10 учебных модулей</span> с примерами и упражнениями, 
                    ...
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0"></div>
                      <p className="text-muted-foreground">
                        <span className="font-medium text-foreground">10 заданий для домашней работы</span>, которые будет 
